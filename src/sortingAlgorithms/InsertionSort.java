...
public class InsertionSort {
    static void Insertion(int[] a){
        ...
        //  index I up to which array is sorted
        for(int i = 0;i < a.length-1;i++){
            ...
            for(int j = i+1;j > 0; j--){
                ...
                // once it reaches zero it means the array is sorted up to index i
                if(a[j] < a[j-1]){
                    swap(a, j, j-1);
                }
                // If element at j is greater than element at j-1
                // which means this element is greatest in the sorted part
